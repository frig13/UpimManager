...
@author: Prohodimec 
"""
# первый модуль на wx, пусть быдлокод, но работает, правда я не знаю как... Программист в середине пути редко понимает начинающего, даже если это один и тот же человек...
import wx, os
